...
export default function BlogIndex({ posts }: { posts: Post[] }) {
  ...
  /* Changing the filter or search resets to page 1. Done in the handlers
   * rather than an effect so there's no extra render pass showing an
   * out-of-range page before it corrects itself. */
  const selectCategory = (key: string) => { setActive(key); setPage(1); };
