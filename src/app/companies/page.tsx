              ...
              {FEATURE_TABS.map((t, i) => activeTab === i && (
                <motion.div key={t.id} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.25 }}>
                  ...
                  <div style={{ position: 'relative', marginBottom: '36px' }}>
                    ...
                    {t.id === 'ai' && (<>
                      <motion.div key="ai-1" className="co-chip" initial={{ opacity: 0, y: -16, scale: 0.9 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ delay: 0.3, duration: 0.45, ease: [0.22,1,0.36,1] }} style={{ top: '-18px', left: '-22px', zIndex: 10 }}>
                      ...
                      <motion.div key="ai-2" className="co-chip" initial={{ opacity: 0, y: 16, scale: 0.9 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ delay: 0.65, duration: 0.45, ease: [0.22,1,0.36,1] }} style={{ bottom: '-18px', right: '-22px', zIndex: 10 }}>
                    ...
                    {t.id === 'collab' && (<>
                      <motion.div key="collab-1" className="co-chip" initial={{ opacity: 0, y: -16, scale: 0.9 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ delay: 0.3, duration: 0.45, ease: [0.22,1,0.36,1] }} style={{ top: '-18px', left: '-22px', zIndex: 10 }}>
                      ...
                      <motion.div key="collab-2" className="co-chip" initial={{ opacity: 0, y: 16, scale: 0.9 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ delay: 0.7, duration: 0.45, ease: [0.22,1,0.36,1] }} style={{ bottom: '-18px', right: '-22px', zIndex: 10 }}>
                    ...
                    {/* ── Pipeline overlays ── */}
                    {t.id === 'pipeline' && (<>
                      <motion.div key="pipe-1" className="co-chip" initial={{ opacity: 0, y: -16, scale: 0.9 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ delay: 0.3, duration: 0.45, ease: [0.22,1,0.36,1] }} style={{ top: '-18px', left: '-22px', zIndex: 10 }}>
                      ...
                      <motion.div key="pipe-2" className="co-chip" initial={{ opacity: 0, y: 16, scale: 0.9 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ delay: 0.7, duration: 0.45, ease: [0.22,1,0.36,1] }} style={{ bottom: '-18px', right: '-22px', zIndex: 10 }}>
                    ...
                    {/* ── Job Board overlays ── */}
                    {t.id === 'board' && (<>
                      <motion.div key="board-1" className="co-chip" initial={{ opacity: 0, y: -16, scale: 0.9 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ delay: 0.3, duration: 0.45, ease: [0.22,1,0.36,1] }} style={{ top: '-18px', left: '-22px', zIndex: 10 }}>
                        <div className="co-chip-icon" style={{ background: '#EEF4FF' }}>
                      ...
                      <motion.div key="board-2" className="co-chip" initial={{ opacity: 0, y: 16, scale: 0.9 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ delay: 0.75, duration: 0.45, ease: [0.22,1,0.36,1] }} style={{ bottom: '-18px', right: '-22px', zIndex: 10 }}>
                        <div className="co-chip-icon" style={{ background: '#F0FDF4' }}>
