...
function GetStartedForm() {
  ...
  /* Organisations don't self-serve an account — Company, Recruitment Agency
  ...
  /* Once the demo request or waitlist signup is in, the left column is just a
     confirmation. The audience chip above it belongs to the form it was
     labelling, so it goes with it rather than floating over the
              ...
              <div className="gs-left-col" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                ...
                <div style={{ marginTop: '24px' }}>
                  <button onClick={() => setStep(2)}
                    ...
                    {isOrg ? 'Book a demo' : 'Continue'} <ArrowRight size={16} />
                  </button>
...
{isOrg ? (
                  ...
                  <WaitlistForm
                    kind={selectedType as WaitlistKind}
                    onSent={() => setLeadSent(true)}
                    footer={
                      <button type="button" onClick={() => setStep(1)}
                        style={{ width: '100%', marginTop: '2px', padding: '12px', background: 'none', color: '#9A9FA8', border: 'none', borderRadius: '10px', fontSize: '13px', fontWeight: 600, fontFamily: 'var(--font-body)', cursor: 'pointer' }}>
