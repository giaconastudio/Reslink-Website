                      ...
                      {currentGroup.map(({ id, icon: Icon, label, desc }) => {
                        ...
                        return (
                          <button key={id} onClick={() => setSelectedType(id)} className={active ? '' : 'gs-type-btn'}
                            ...
                            <div style={{ flex: 1 }}>
                              <p style={{ fontSize: '14px', fontWeight: 700, color: active ? '#041635' : '#041635', fontFamily: 'var(--font-body)', lineHeight: 1.2 }}>{label}</p>
                              <p style={{ fontSize: '12px', color: active ? '#5C6070' : '#9A9FA8', fontFamily: 'var(--font-body)', marginTop: '2px', lineHeight: 1.3 }}>{desc}</p>
                            </div>
