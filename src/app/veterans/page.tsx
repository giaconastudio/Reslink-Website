      ...
      <main style={{ paddingTop: '68px' }}>
        ...
        <section style={{ background: '#061A3A', overflow: 'hidden', position: 'relative' }}>
          ...
          <div style={{ maxWidth: '1120px', margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0', alignItems: 'stretch', minHeight: '600px' }} className="vets-hero-grid">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
              ...
              <h1 className="audience-hero-h1" style={{ fontFamily: 'var(--font-phudu)', fontSize: 'clamp(48px, 4vw, 56px)', fontWeight: 900, color: '#fff', lineHeight: 1.0, letterSpacing: '-0.03em', marginBottom: '24px' }}>
              ...
              <div className="vets-hero-discount" style={{ marginTop: '30px', paddingTop: '26px', borderTop: '1px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', gap: '30px' }}>
            ...
            <motion.div className="vets-hero-img-col" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }}
              ...
              <div style={{ position: 'relative', width: '100%', maxWidth: '380px' }}>
                ...
                <div style={{ position: 'relative', width: '100%', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 32px 80px rgba(0,0,0,0.5)', aspectRatio: '3/4', zIndex: 1 }}>
                  <video src="/videos/military.mp4" poster="/videos/military-poster.jpg" autoPlay muted loop playsInline preload="metadata"
        ...
        <section style={{ background: '#fff', padding: 'clamp(72px, 9vw, 108px) 24px', overflow: 'hidden' }}>
          <div style={{ maxWidth: '1060px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', alignItems: 'center' }} className="vets-split-grid">
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.5, delay: 0.1 }}>
        ...
        <section style={{ background: '#061A3A', padding: 'clamp(72px, 9vw, 108px) 24px', overflow: 'hidden' }}>
          <div style={{ maxWidth: '1060px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', alignItems: 'center' }} className="vets-pip-grid">
            <style>{`@media (max-width: 820px) {
              .vets-pip-grid { grid-template-columns: 1fr !important; gap: 40px !important; }
              .vets-pip-grid > * { min-width: 0; }
              /* Matches students: the only left-aligned section header once
                 stacked, so it centres with the rest. */
              .vets-pip-copy { text-align: center; }
              /* Rows stay left-aligned so the tick icons line up; the block is
                 what gets centred. */
              .vets-pip-list { width: fit-content; margin-left: auto; margin-right: auto; text-align: left; }
            }`}</style>
            <motion.div className="vets-pip-copy" initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.5 }}>
              ...
              <div className="vets-pip-list" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <div style={{ borderRadius: '18px', border: '2px solid #D7FF43', overflow: 'hidden', boxShadow: '0 24px 72px rgba(0,0,0,0.4)' }}>
                <div style={{ background: '#0C1B3A', padding: '20px 22px' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '14px', paddingRight: '80px' }}>
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src="/images/military-avatar.jpg"
