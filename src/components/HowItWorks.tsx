          ...
          {steps.map((step, i) => (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
                <div style={{ width: '36px', height: '36px', borderRadius: '10px', background: '#FFF0EB', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <h3 style={{ fontSize: '15px', fontWeight: 700, color: '#0B1437', marginBottom: '8px' }}>{step.title}</h3>
